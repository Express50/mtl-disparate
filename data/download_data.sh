...
mkdir semeval2016-task6-stance -p ; cd semeval2016-task6-stance
...
mkdir fakenewschallenge -p ; cd fakenewschallenge
...
mkdir multinli -p; cd multinli
wget https://cims.nyu.edu/~sbowman/multinli/multinli_0.9.zip
...
mkdir semeval2016-task4b-topic-based-sentiment -p ; cd semeval2016-task4b-topic-based-sentiment
...
mkdir semeval2016-task4c-topic-based-sentiment -p ; cd semeval2016-task4c-topic-based-sentiment
...
mkdir semeval2016-task5-absa-english -p ; cd semeval2016-task5-absa-english
...
mkdir target-dependent -p ; cd target-dependent
